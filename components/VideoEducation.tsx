        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4 items-start">
            ...
            <DynamicLeadCaptureCTA
              fallbackLabel={'Book a Free 1:1 Consultation \u2192'}
              offerTag="consultation_request"
              source="video_education"
              fallbackSuccessMessage="Thanks! We'll reach out to schedule your consultation."
              fallbackVariant="ochre"
            />
          </div>
        </div>
